...
def test_login_invalid_credentials(client):
    ...
    r = client.post(
        "/auth/login",
        json={"email": "c@example.com", "password": "wrongpwd"},
    )
...
def test_me_with_cookie(client):
    client.post(
        "/auth/register",
        json={"email": "d@example.com", "password": "password"},
    )
...
def test_me_with_bearer_header(client):
    reg = client.post(
        "/auth/register",
        json={"email": "e@example.com", "password": "password"},
    )
...
def test_logout_clears_cookie(client):
    client.post(
        "/auth/register",
        json={"email": "f@example.com", "password": "password"},
    )
